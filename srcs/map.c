...
/*   Updated: 2016/01/09 21:16:42 by mlinhard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	map_str[calc_check_pos(i, diez[0][0], diez[0][1], map_size)] = (char)(diez[0][2]);
	map_str[calc_check_pos(i, diez[1][0], diez[1][1], map_size)] = (char)(diez[1][2]);
	map_str[calc_check_pos(i, diez[2][0], diez[2][1], map_size)] = (char)(diez[2][2]);
	map_str[calc_check_pos(i, diez[3][0], diez[3][1], map_size)] = (char)(diez[3][2]);
	return (map_str);
}
